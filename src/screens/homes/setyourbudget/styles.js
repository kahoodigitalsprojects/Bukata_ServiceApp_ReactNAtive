...
const styles = StyleSheet.create({
  ...
  offerView: {marginTop: 10, borderBottomWidth: 1},
  offerText: {
  ...
  // ==============textinput================
  Textinputbudget: {fontSize: 18, marginLeft: 5, width: '100%'},

  // ===============warning=============
  warningView: {alignItems: 'center', marginVertical: 2, borderRadius: 20},
